...
const MenuCard = ({name,totalRatingsString,avgRating,itemCards,deliveryTime,cuisines,areaName,costForTwoMessage}) => {
    console.log(itemCards);
    return (
        <div className="container mx-auto">
            <div className="grid grid-cols-2 mt-3 border-b" style={{ color: "#3e4152", fontWeight: "800" }}>
            ...
            ></div>
            <div>
                <h4 className="flex gap-1 mt-0.5 justify-center m-3">
